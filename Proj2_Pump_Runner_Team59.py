...
def runPumps(currStep, currCosts, segmentVals, currMaxVal, currMaxSegVals, currMaxSite):
    step = currStep
    costs = currCosts
    maxVal = currMaxVal
    ...
    for p in pumps:
        ...
        [step, maxVal, maxSegVals, maxSite] = runParts(step, costs, segmentVals, maxVal, maxSegVals, maxSite)
